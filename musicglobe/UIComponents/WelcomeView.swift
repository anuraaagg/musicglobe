    ...
    ZStack {
      ...
      ScrollView {
        ZStack {
          ...
          VStack {
            Spacer()
              .frame(height: 500) // Push button down, allowing scroll
            ...
            if !appState.isSpotifyConnected {
              Button {
                ...
                Text("Connect with Spotify")
                  ...
                  .shadow(
                    color: Color(red: 0.11, green: 0.73, blue: 0.33).opacity(0.5), radius: 20, y: 0)
              }
              .padding(.bottom, 60)
        ...
        .frame(minHeight: 700) // Ensure scrollable area
      }
    }
    .onAppear {
